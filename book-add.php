          ...
          <div class="box box-primary">
            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="copy_of_book">Copy of Book </label>
                  <input type="text" class="form-control" name="copy_of_book" id="copy_of_book" placeholder="Enter book Author">
                </div>
